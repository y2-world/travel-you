...
<div class="container">
    ...
    <hr>
    <div class="menu">
        <a class="menu" href="{{ route('login.guest') }}">ゲストログイン</a>
        <a class="menu" href="{{ url('/faq') }}">FAQ</a>
        <a class="menu" href="{{ url('/contact') }}">お問い合わせ</a>
        <a class="menu" href="http://54.249.81.67">NIPPO</a>
        <a class="menu" href="https://y2world.github.io/home/" target="_blank">YUKI OFFICIAL</a>
    </div>
    <hr>
    <div style="text-align:center;">
    今までのあなたの旅の歴史を記録し、<br>
    <span>さらにこれからのあなたの旅を</span>より楽しいものにするツールです。<br>
    旅行記を作ったり、<br>
    旅行先でのトラブルをシェアしたり、<br>
    疑問に思ったことを質問したり... <br>
    楽しみ方は何通りもあります。<br>
